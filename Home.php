...
<body>
        ...
        <div id="listHab">
            ...
            <div class="cadre">
                <div class="image1"><a href="detailedHab.php?idUser=<?php echo $idUser ?>&pic=<?php echo $fetch['housepic']; ?>&quartier=<?php echo $fetch['quartier']; ?>&host=<?php echo $fetch['host']; ?>&loyer=<?php echo $fetch['loyer']; ?>"><img src="Pic/<?php echo $fetch['housepic']; ?>" width="250" height="200"></a></div>
                <br>

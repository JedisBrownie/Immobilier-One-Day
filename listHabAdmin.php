...
<body>
    <div id="sary1"><img src="Pic/sary2.jpg"></div>
    <div id="titre">
        <h2 id="title1" >The villa rental expert for your travel.</h2>
        <h1 id="title2">Book your villa online quickly and safely</h1>

        <h3 id="title3">Homes Around the World</h3>
